...
<body class="hold-transition skin-blue sidebar-mini">
							...
							<div class="form-group form-inline">
								<div class="btn-group">
									<button type="button" class="btn btn-default" title="新建"
										onclick='location.href="${pageContext.request.contextPath}/product/initAddProduct"'>
								...
								<c:forEach items="${page.list }" var="product">
									...
									<td class="text‐center">
										<button type="button" class="btn bg‐olive btn‐xs"
											onclick='location.href="${pageContext.request.contextPath}/product/initUpdateProduct?id=${product.id}"'>修改</button>
										<button type="button" class="btn bg‐olive btn‐xs"
											onclick='delProductById(${product.id})'>删除</button>
									</td>
									</tr>
								</c:forEach>
							</tbody>
    ...
    <script>
        //分页查询, 每页显示几条数据 
	    function submitPageSize(select) {
	    	location.href="${pageContext.request.contextPath}/product/findProductByPageHelper?pageSize=" + select.value;
	    }
	    
	    //提交当前页
	    function submitPageNum(pageNum) {
	    	location.href="${pageContext.request.contextPath}/product/findProductByPageHelper?pageNum=" + pageNum;
	    }
    </script>
    ...
    <script>
	    function delProductById(id) {
	    	if(confirm("确认删除吗?")){
	    		location.href="${pageContext.request.contextPath}/product/delProductById?id=" + id;
	    	}
	    }
    </script>
